...
const AR = () => {
  ...
  const questions = [
    {
      id: 1,
      assertion: "Primary growth of the plants contributes to the elongation of the plants along their axis.",
  ...
  const handleSubmit = (questionId) => {
    ...
    const correctAnswer = questions.find(q => q.id === questionId).correctOption;
