...
const Subjective = () => {
  ...
  const questions = [
    {
      ...
      modelAnswer: "Paris is the capital and largest city of France. It is an important cultural, political, and economic center."
    },
    {
      id: 2,
      question: "Explain why Mars is known as the Red Planet.",
      modelAnswer: "Mars is often called the Red Planet because of its reddish appearance, which is due to iron oxide or rust on its surface."
    },
    {
      id: 3,
      question: "Summarize the plot of 'Hamlet' by William Shakespeare.",
      modelAnswer: "Hamlet is a tragedy by William Shakespeare where the prince of Denmark seeks revenge against his uncle, who has murdered his father, taken the throne, and married Hamlet's mother."
    },
    {
      id: 4,
      question: "Write about the contributions of William Shakespeare to English literature.",
      modelAnswer: "William Shakespeare is considered one of the greatest writers in the English language, known for his plays, sonnets, and poems."
    },
    {
      id: 5,
      question: "Write about the contributions of William Shakespeare to English literature.",
  ...
  const handleSubmit = (questionId) => {
    ...
    if (userAnswers[questionId].toLowerCase().includes(questions.find(q => q.id === questionId).modelAnswer.toLowerCase())) {
      setFeedback({
        ...feedback,
